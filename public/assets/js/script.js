...
{
    var data ={
        'iduser': $("#chat-list li.active").attr("userid"),
...
function deleteMes(l,elm)
{ 
    var data=
    {id:l,"_token": $('meta[name="csrf-token"]').attr('content')}
     $.ajax({
                 type: "POST",
                 url: "/deletemes",
                 data: data,
                 ...
                 success: function(data)
                 { 
                   $(elm).parent().parent().parent().parent().parent().parent().parent().parent().parent().parent().remove();
                 },
                 error : function (e){      
...
{  
    var data=
    {id:e.attr('iduser'),answer:0,"_token": $('meta[name="csrf-token"]').attr('content')}
...
(function($) {
    ...
    $('.bg-img').each(function() {
           ...
           var userid=$('meta[name="author"]').attr('content');
            ...
            $.ajax({
                ...
                { 
                    ...
                    { 
                          if(data[0][i].sender.toString()!==userid)
                        {
                                            ...
                                            <li class="msg-setting-main">\
                                                ...
                                                <div class="msg-dropdown-main">\
                                                    ...
                                                    <div class="msg-dropdown">\
                                                        <ul>\
                                                            <li><a onclick="deleteMes('+data[0][i].messageid+',this)" href="#"><i class="ti-trash"></i>delete</a></li>\
                                                            <li><a class="chuyentiep" idmes="'+data[0][i].messageid+'" href="#"><i class="ti-arrow-top-right"></i>Forward</a></li>\
                                                        </ul>\
                                                    </div>\
                                                </div>\
                                            </li>\
                                    ...
                                    <li class="msg-setting-main">\
                                      ...
                                      <div class="msg-dropdown-main">\
                                        ...
                                        <div class="msg-dropdown">\
                                                        <ul>\
                                                            <li><a onclick="deleteMes('+data[0][i].messageid+',this)" href="#"><i class="ti-trash"></i>delete</a></li>\
                                                            <li><a idmes="'+data[0][i].messageid+'" class="chuyentiep" href="#"><i class="ti-arrow-top-right"></i>Forward</a></li>\
                                                        </ul>\
                                        </div>\
                                      </div>\
                                    </li>\
                        ...
                        else if(data[0][i].type=="image")
                        {
                            contents+='<li class="'+s+'">\
                            <div class="media">\
                              <div class="profile mr-4 bg-size" style="background-image: url('+avt+'); background-size: cover; background-position: center center; display: block;"><img class="bg-img" src="../assets/images/contact/2.jpg" alt="Avatar" style="display: none;"></div>\
                              <div class="media-body">\
                                <div class="contact-name">\
                                  <h5>'+name+'</h5>\
                                  <h6>'+data[0][i].time+'</h6>\
                                  <ul class="msg-box">\
                                    ...
                                    <li class="msg-setting-main">\
                                      <ul >\
                                        <li >\
                                        <img src="../storage/'+data[0][i].content+'" class="img-fluid" alt="Responsive image">\
                                      </ul>\
                                      <div class="refresh-block">\
                                        <div class="badge badge-outline-primary refresh sm ml-2"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-rotate-cw"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg></div>\
                                      ...
                                      <div class="msg-dropdown-main">\
                                        ...
                                        <div class="msg-dropdown">\
                                            <ul>\
                                                <li><a onclick="deleteMes('+data[0][i].messageid+',this)" href="#"><i class="ti-trash"></i>delete</a></li>\
                                                <li><a download href="../storage/'+data[0][i].content+'"><i class="fa fa-download"></i>Download</a></li>\
                                                <li><a idmes="'+data[0][i].messageid+'" class="chuyentiep" href="#"><i class="ti-arrow-top-right"></i>Forward</a></li>\
                                            </ul>\
                                        </div>\
                                      </div>\
                                ...
                                <div class="contact-name">\
                                  ...
                                  <ul class="msg-box">\
                                    ...
                                    <li class="msg-setting-main">\
                                      <ul >\
                                        <li >\
                                        <video  src="../storage/'+data[0][i].content+'" autoplay></video>\
                                      </ul>\
                                      <div class="refresh-block">\
                                        <div class="badge badge-outline-primary refresh sm ml-2"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-rotate-cw"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg></div>\
                                        <div class="badge badge-danger sm ml-2">F</div>\
        ...
        $("#groupchat").on("click","li",function(){


           var chanel =$("#groupchat li.active").attr("groupid");
            ...
            $(this).addClass("active");
           var id =$("#groupchat li.active").attr("groupid");
            var data=
            {id:id}
            $.ajax({
                type: "GET",
                url: "/loadMessageGroup",
                data: data,
                ...
                success: function(data)
                {
                            ...
                            { 
                               ...
                               $("#content-chat-gruop").html(contents);
                },
                error : function (e){      
        ...
        $("#createGruopButton").click(function(){
            if( !$("#gruopChose li").hasClass("active")){
                toastr.error("You not select any person");
            }
            else
            {
                var ar=[];
                // for(var i=0;i<$("#gruopChose li").length;i++)
                // {  
                //     var m=$("#gruopChose li")[i].attr("userid");
                //     console.log(m)
                //     //ar.push()
                // }
                $("#gruopChose li").each(function () {
                ...
                console.log(ar);
                var data=
                {id:ar,"Title":$("#Title").val(),"_token": $('meta[name="csrf-token"]').attr('content')}
                 $.ajax({
                             type: "POST",
                             url: "/createGruop",
                             data: data,
        ...
        $(".msg-dropdown-main").click(function() {
            console.log("s")
                ...
                for(var i=0;i<data.ketqua.length;i++){
                        ...
                        <div class="profile  bg-size" style="background-image: url('+avt+'); background-size: cover; background-position: center center; display: block;"><img class="bg-img" src="../assets/images/contact/1.jpg" alt="Avatar" style="display: none;"></div>\
                            ...
                            <div class="date-status">\
                                <h6>'+joindate+'</h6>\
                                <div id="'+data.ketqua[i].userid+'" class="media-body" onclick="Addfriend($(this))">\
    ...
    $("#submitInfo").click(function(e)
    {
        e.preventDefault();
         $.ajax({
             type: "POST",
             url: "/changeLoginInfo",
             data: $("#changeLoginInfo").serialize(),
             success: function(data)
             { 
                 
                toastr.success("Your infomation has been update")
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                for(var i=0;i<data.recoment.length;i++){
                        ...
                        var j=' <li>\
                        <div class="chat-box">\
                        <div class="profile  bg-size" style="background-image: url('+avt+'); background-size: cover; background-position: center center; display: block;"><img class="bg-img" alt="Avatar" style="display: none;"></div>\
                            <div class="details">\
                                <h5>'+name+'</h5>\
                                <h6>'+about+'</h6>\
                            </div>\
    ...
    $("#callVideoButton").click(function(){
            ...
            { 
                ...
                $.ajax({
                        ...
                        if(data)
                        {
                            ...
                            // $('<li class="replies"> <div class="media"> <div class="profile mr-4 bg-size" style="background-image: url('+avt+'); background-size: cover; background-position: center center;"></div><div class="media-body"> <div class="contact-name"> <h5>You</h5> <h6>'+new Date().toLocaleTimeString()+'</h6> <ul class="msg-box"> <li> <h5>' + message + '</h5> </li></ul> </div></div></div></li>').appendTo($('.messages .chatappend'));
                            $('#setemoj').val(null);
                ...
                var data ={
                    'id': $("#groupchat li.active").attr("groupid"),
                    'message':message,
                }
                    $.ajax({
                        type: "POST",
    ...
    $('.sticker-contain ul li').on('click', function(e) {
        ...
        $('<li class="replies"> <div class="media"> <div class="profile mr-4 bg-size" style="background-image: url("../assets/images/contact/1.jpg"); background-size: cover; background-position: center center;"></div><div class="media-body"> <div class="contact-name"> <h5>You</h5> <h6>'+new Date().toLocaleTimeString()+'</h6> <ul class="msg-box"> <li> <h5>' + sticker + '</h5> </li></ul> </div></div></div></li>').appendTo($('.messages .chatappend'));
    ...
    $(document).on("click", ".chuyentiep", function () {
         var myBookId = $(this).attr("idmes")
         idmesforward=myBookId;
   ...
   $(".forwardclass").on("click",function(e)
   {
        var chanel= $(this).data("value");  

    var data=
    {chanel:chanel,"_token": $('meta[name="csrf-token"]').attr('content'),id:idmesforward}
     $.ajax({
                 type: "POST",
                 url: "/forward",
                 data: data,
